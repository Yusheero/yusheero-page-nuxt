<template>
    <div class="terminal-grid">
      <div class="terminal-grid__container">
        <!-- Сетка на весь контент -->
        <div class="terminal-grid__overlay"></div>
        
        <!-- Эффекты терминала -->
        <div class="terminal-grid__crt-effect"></div>
        <div class="terminal-grid__noise-effect"></div>
        <div class="terminal-grid__scanline-effect"></div>
        <div class="terminal-grid__crt-lines"></div>
        
        <!-- Эффект затемнения сверху и снизу экрана -->
        <div class="terminal-grid__vignette"></div>
      </div>
    </div>
</template>
